	...
	<div class="col-lg-12 col-sm-12 col-xs-12">
		<div class="well with-header with-footer">
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
					<?php if(is_array($list)): foreach($list as $key=>$goods): ?><tr>
						...
						<td>
							<?php if(file_exists($goods['pic'])): ?><img src="/<?php echo ($goods["pic"]); ?>" width="60" height="60"><?php endif; ?>
						</td>
						<td><?php echo ($goods["goods_name"]); ?></td>
						<td><?php echo ($goods["brand"]["brand_name"]); ?></td>
						<td><?php echo ($goods["goods_category"]["cate_name"]); ?></td>
						<td>￥<?php echo ($goods["market_price"]); ?></td>
						<td>￥<?php echo ($goods["shop_price"]); ?></td>
						<td>
							<a href="<?php echo U('edit',['id'=>$goods['id']]);?>" class="btn btn-info btn-xs">
								<i class="fa fa-edit"></i> 修改
							</a>
							<a href="<?php echo U('del',['id'=>$goods['id']]);?>" class="btn btn-danger btn-xs">
			...
			<div class="row DTTTFooter" style="margin-top:10px;">
					...
					<div class="dataTables_info" id="simpledatatable_info" role="alert" aria-live="polite" aria-relevant="all">Showing 1 to 5 of 25 entries</div></div>
					<div class="col-sm-6 col-lg-6 col-xs-6"><?php echo ($page); ?></div>
