			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
					<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
						<td><?php echo ($v["id"]); ?></td>
						<td class="hidden-xs"><?php echo ($v["attr_name"]); ?></td>
						<td>
							<?php if(is_array($v["attr_items"])): foreach($v["attr_items"] as $key=>$s): if(!empty($key)): ?>、<?php endif; ?>
							<?php echo ($s["attr_value"]); endforeach; endif; ?>
						</td>
						<td>
