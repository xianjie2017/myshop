	...
	<div class="col-lg-12 col-sm-12 col-xs-12">
		<div class="well with-header with-footer">
			...
			<div class="widget-main">
				<form class="form-horizontal" role="form" action="/tp3/Admin/Spec/add" method="post">
					<!-- 分类名称 -->
					<div class="form-group">
						<label for="spec_name" class="col-sm-2 control-label no-padding-right">规格名称</label>
						<div class="col-sm-10">
							<input type="text" value="<?php echo ((isset($data["spec_name"]) && ($data["spec_name"] !== ""))?($data["spec_name"]):''); ?>" class="form-control" name="spec_name" id="spec_name" placeholder="规格名称">
						</div>
					</div>	
					
					<!-- 简介 -->
					<div class="form-group">
						<label for="spec_value" class="col-sm-2 control-label no-padding-right">规格选项</label>
						<div class="col-sm-10">
							<textarea class="form-control" rows="6" name="spec_value" id="spec_value" placeholder="规格选项"><?php echo ((isset($items) && ($items !== ""))?($items):''); ?></textarea>
							<p>一行为一个规格选项</p>
						</div>
					</div>
