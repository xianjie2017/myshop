			...
			<table class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th class="hidden-xs">
							<i class="fa  fa-font"></i> 分类名称
						</th>
						<th>
							<i class="fa fa-user"></i> 父级分类
						</th>
						<th>
				...
				<tbody>
					<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
						<td><?php echo ($v["id"]); ?></td>
						<td class="hidden-xs"><?php if(($v['level']) != "1"): ?>├<?php endif; echo str_repeat('──',$v['level'] - 1); echo ($v["cate_name"]); ?></td>
						<td><?php echo ($v["goods_category"]["cate_name"]); ?></td>
						<td>
